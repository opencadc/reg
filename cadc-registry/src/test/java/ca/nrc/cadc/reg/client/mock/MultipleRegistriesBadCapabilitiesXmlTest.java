...
/**
 * A set of Junit tests that use a MockServer to test a how the RegistryClient handles a bad service capabilities response. 
 * See https://www.mock-server.com/
 * 
 */
public class MultipleRegistriesBadCapabilitiesXmlTest
    {
    ...
    public MultipleRegistriesBadCapabilitiesXmlTest() {
        super();
    }
    ...
    public void testBadCapabilitiesXmlOnce()
        ...
        //
        // The registry client should have called the 'bad-capabilities' endpoint once to get the service capabilities.
        // The bad XML response is cached as vaild content and the XML parser error happens after the CacheFile returns it.
        mockServer.verify(
            request()
                .withPath(
    ...
    public void testBadCapabilitiesXmlTwice()
        ...
        //
        // The registry client should have called the 'bad-capabilities' endpoint once to get the service capabilities.
        // The bad XML response is cached as valid content and the XML parser error happens after the CacheFile returns it.
        mockServer.verify(
            request()
                .withPath(
                    "/good-service/bad-capabilities"
        ...
        //
        // The registry client should have used the cached version of 'resource-caps' response and should not not have called the first 'resource-caps' endpoint again.
        mockServer.verify(
            request()
                .withPath(
                    "/good-registry-one/resource-caps"
        ...
        //
        // The registry client should have used the cached version of 'bad-capabilities' response and should not not have called the 'bad-capabilities' endpoint again.
        // The bad XML response is cached as valid content and the XML parser error happens after the CacheFile returns it.
        mockServer.verify(
            request()
                .withPath(
