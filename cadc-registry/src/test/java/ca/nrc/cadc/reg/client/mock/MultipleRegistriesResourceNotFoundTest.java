 ...
 * 
 */
public class MultipleRegistriesResourceNotFoundTest
    {
    ...
    public void testRegistryResourceNotFoundOnce()
        ...
        //
        // The registry client should have called the 'resource-caps' endpoint on each registry twice, once to try to populate the cache,
