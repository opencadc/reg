 ...
 * 
 */
public class SingleRegistryResourceNotFoundTest
    {
    private static final Logger log = Logger.getLogger(SingleRegistryResourceNotFoundTest.class);
    static {
    ...
    public SingleRegistryResourceNotFoundTest() {
        super();
    }
