 ...
 *
 */
public class MixedHostnamesResponseTimeoutTest
    {
    private static final Logger log = Logger.getLogger(MixedHostnamesResponseTimeoutTest.class);
    static {
    ...
    public void setupRegClient()
        ...
        printWriter.print(
                "ca.nrc.cadc.reg.client.RegistryClient.baseURL = http://testhost-one:1080/slow-registry-one"
              + "\n"
