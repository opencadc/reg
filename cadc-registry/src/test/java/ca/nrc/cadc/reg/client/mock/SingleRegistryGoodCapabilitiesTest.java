 ...
 * 
 */
public class SingleRegistryGoodCapabilitiesTest
    {
    private static final Logger log = Logger.getLogger(SingleRegistryGoodCapabilitiesTest.class);
    static {
    ...
    public SingleRegistryGoodCapabilitiesTest() {
        super();
    }
