...
/**
 * A set of Junit tests that use a MockServer to test a how the RegistryClient handles dropped connection. 
 * See https://www.mock-server.com/
 * 
 */
public class MixedHostnamesDroppedConnectionTest
extends MockServerTestBase
    {
    private static final Logger log = Logger.getLogger(MixedHostnamesDroppedConnectionTest.class);
    static {
    ...
    public void testMixedDropConnectionRegistry()
        ...
        RegistryClient registryClient = buildRegistryClient(
            ...
            "http://testhost-002:1080/good-registry-one",
            "http://testhost-003:1080/good-registry-two"
            );
